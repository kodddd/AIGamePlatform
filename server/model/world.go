...
type (
	...
	World struct {
		...
		BaseText    string               `json:"base_text" bson:"base_text"`
		WorldName   string               `json:"world_name" bson:"world_name"`
		Characters  []primitive.ObjectID `json:"characters" bson:"characters"`
		Storys      []primitive.ObjectID `json:"storys" bson:"storys"`
		Deleted     bool                 `json:"deleted" bson:"deleted"`
		LastUpdated int64                `json:"last_updated" bson:"last_updated"`
	...
	GetWorldCharactersResult struct {
		Code       int          `json:"code"`
		Message    string       `json:"message"`
		Characters []*Character `json:"characters"`
	}
	GetWorldStoriesResult struct {
		Code    int      `json:"code"`
		Message string   `json:"message"`
		Storys  []*Story `json:"storys"`
	}
)
